	...
	return (
		<html>
			<head>
				...
				<meta name="description" content="今日热榜 API，一个聚合热门数据的接口" />
			...
			<body>
				...
				<footer>
					<div class="social">
						<a href="https://github.com/daylight2022/DailyHotApi.git" target="_blank" className="link">
						...
						<a href="https://aiwonders.cn" target="_blank" className="link">
					...
					<div class="power">
						Copyright&nbsp;©&nbsp;
						<a href="https://aiwonders.cn" target="_blank">
							Kody
						</a>
						&nbsp;|&nbsp;Power by&nbsp;
